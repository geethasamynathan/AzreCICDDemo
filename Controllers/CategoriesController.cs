...
using AzreCICDDemo.Models;

namespace AzreCICDDemo.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public CategoriesController(PracticeDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Category>> PostCategory(Category category)
        {
          if (_context.Categories == null)
          {
              return Problem("Entity set 'PracticeDBContext.Categories'  is null.");
          }
